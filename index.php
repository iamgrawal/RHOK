...
<body id="body" data-spy="scroll" data-target=".one-page-header" class="demo-lightbox-gallery dark">
            ...
            <div class="fullscreenbanner">
                <ul>
                    ...
                    <li data-transition="curtain-1" data-slotamount="5" data-masterspeed="700" data-title="Slide 1">
                        <!-- MAIN IMAGE -->
                        <img src="assets/img/sliders/revolution/bgar1.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption rs-caption-1 sft start"
                            ...
                            data-endspeed="300">
                            WE ARE SOCIAL SWACHHTA COMPANY
                        </div>
                        ...
                        <div class="tp-caption rs-caption-2 sft"
                            ...
                            style="z-index: 6">
                            Do not litter, keep it cleaner.<br>
                            We minimize the gap between technology and  public.
                        </div>
                    ...
                    <li data-transition="slideup" data-slotamount="5" data-masterspeed="1000" data-title="Slide 2">
                        <!-- MAIN IMAGE -->
                        <img src="assets/img/sliders/revolution/bgar2.jpg" alt="slidebg1"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption rs-caption-2 sft"
                            ...
                            key swacchta services on web and mobile.
                        </div>
                    ...
                    <li data-transition="slideup" data-slotamount="5" data-masterspeed="700"  data-title="Slide 3">
                        <!-- MAIN IMAGE -->
                        <img src="assets/img/sliders/revolution/bgar3.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption rs-caption-2 sfb"
                            ...
                            data-captionhidden="off"
                            style="z-index: 6">
                            Swachha bharat, swastha bharat.<br>
                            We minimize the gap between technology and public.
                        </div>
                ...
                <ul class="list-unstyled row">
                    <li class="col-sm-3 col-xs-6 md-margin-bottom-30">
                        <div class="team-img">
                            ...
                            <ul>
                                <li><a href="#" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-twitter"></i></a></li>
                                <li><a href="https://www.facebook.com/profile.php?id=100010896942870" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-facebook"></i></a></li>
                                <li><a href="mailto:shaury29.baran wal@gmail.com" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-google-plus"></i></a></li>
                            </ul>
                        </div>
                        <h3>Shaury Baranwal</h3>
                        <h4>Web Developer</h4>
                                           </li>
                    <li class="col-sm-3 col-xs-6 md-margin-bottom-30">
                        <div class="team-img">
                            ...
                            <ul>
                                <li><a href="#" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-twitter"></i></a></li>
                                <li><a href="https://www.facebook.com/gaurravrawal" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-facebook"></i></a></li>
                                <li><a href="mailto:itsmegauravrawal@gmail.com" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-google-plus"></i></a></li>
                            </ul>
                        </div>
                        <h3>Gaurav Rawal</h3>
                        <h4>Lead Designer</h4>
                    ...
                    <li class="col-sm-3 col-xs-6">
                        <div class="team-img">
                            ...
                            <ul>
                                <li><a href="#" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-twitter"></i></a></li>
                                <li><a href="https://www.facebook.com/nikhilandsharma" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-facebook"></i></a></li>
                                <li><a href="mailto:nikhil722sharma@gmail.com" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-google-plus"></i></a></li>
                            </ul>
                        </div>
                        <h3>Nikhil Sharma</h3>
                        <h4>Web Developer</h4>
                    ...
                    <li class="col-sm-3 col-xs-6">
                        <div class="team-img">
                            ...
                            <ul>
                                <li><a href="#" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-twitter"></i></a></li>
                                <li><a href="https://www.facebook.com/chhavnish?ref=br_rs" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-facebook"></i></a></li>
                                <li><a href="mailto:chhavnish@gmail.com" target="_blank"><i class="icon-custom icon-sm rounded-x fa fa-google-plus"></i></a></li>
                            </ul>
                        </div>
                        <h3>Chhavnish</h3>
    ...
    <section id="upload">
        <div class="container content-lg">
            <div class="title-v1">
                <h2>Upload Images of Garbage</h2>
                <p>If you feel there is some litter in your locality, then please share it with us <br>by uploading pic of garbage 
				and location so that we can clean it for you.</p>
            </div>
			...
			<form action="" method="post" id="sky-form3" class="sky-form contact-style">
                ...
                <fieldset>
                           <center>
							<p style="display:inline"><input id="uploadFile" type="text" disabled="disabled" placeholder="Choose File" /></p>
							<div class="file-upload btn btn-primary">
								<span>Upload</span>  
								<input class="upload" name="image" id="uploadBtn" type="file" />
							</div>
							<div>
                                <input type="text" name="location" id="location" placeholder="Address">
                            </div class=" btn btn-primary">
							<div>
                                <br><button type="submit" class="btn-u btn-brd btn-brd-hover btn-u-dark" name="submit" >Submit</button></p>
								<?php
									
									if (isset($_POST["submit"])) {
									
									$image_1 = addslashes(file_get_contents($_FILES['image']['tmp_name']));
									...
									$sql = "INSERT INTO image(image, location) VALUES ('$image_1','$location')";
    ...
    <section id="contact" class="contacts-section">
        <div class="container content-lg">
            ...
            <div class="row contacts-in">
                <div class="col-md-6 md-margin-bottom-400>
                    <ul class="list-unstyled">
                        <li><i class="fa fa-home"></i> Address,New Delhi</li>
                        <li><i class="fa fa-phone"></i> +91-9876543210</li>
                        <li><i class="fa fa-envelope"></i> <a href="#">swachhta@gmail.com</a></li>
                        <li><i class="fa fa-globe"></i> <a href="index.php">www.swachhta.com</a></li>
                    </ul>
                </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-7 margin-bottom-20 col-md-offset-0">
                                    <div>
                                        <input type="text" name="contact_name" id="name" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-7 margin-bottom-20 col-md-offset-0">
                                    <div>
                                        <input type="text" name="contact_email" id="email" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-11 margin-bottom-20 col-md-offset-0">
                                    <div>
                                        <textarea rows="8" name="contact_message" id="message" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                            
                            <p><button type="submit"name ="contact_us"  class="btn-u btn-brd btn-brd-hover btn-u-dark">Send Message</button></p>
                            <?php
